...
void MainMenuView::selectButton(int index) {
    switch (index) {
    case 0: hoveredButton = &startButton; break;
    case 1: hoveredButton = &changeColorButton; break;
    case 2: hoveredButton = &leaderboardButton; break;
    case 3: hoveredButton = &exitButton; break;
    default: hoveredButton = nullptr; break;
    }
    updateButtonAppearance();
}
